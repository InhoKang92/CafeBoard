<template>
    <div class="bodyLeft">
        <div class="writeHeader">
            <h3 class="boardTitle">카페 글쓰기</h3>
            <div class="writeButtons">
                <button class="temp_register">임시등록</button>
                <button class="register" @click="register">등록</button>
            </div>
        </div>
            ...
            <div>
                ...
                <div class="boardSelect" name="boardSelect">
                    <div class="selected" @click="boardSelectShow2">
                        <div class="selected-value" ref="selectedValue2" style="color: #ccc;">{{ selectedValue2 }}</div>
